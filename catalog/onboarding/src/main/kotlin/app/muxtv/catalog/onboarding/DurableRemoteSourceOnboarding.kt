...
class DurableRemoteSourceOnboarding(
    ...
    override suspend fun activate(
        ...
        if (cleanupComplete) {
            removeRegistryBestEffort(token)
        }
        return result
    }
    ...
    private suspend fun removeRegistryBestEffort(token: RemoteSourcePreparationToken) {
        removeRegistryByIdBestEffort(token.value)
    }
