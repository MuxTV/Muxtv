...
val verifyCurrentRoomSchema = tasks.register("verifyCurrentRoomSchema") {
    group = "verification"
    description = "Verifies that the current generated Room schema is committed and matches the database version."
    ...
    doLast {
        ...
        if (schemaVersion != currentVersion) {
            throw GradleException(
                "Room schema version mismatch: source=$currentVersion artifact=$schemaVersion ($schemaFile).",
            )
        }
