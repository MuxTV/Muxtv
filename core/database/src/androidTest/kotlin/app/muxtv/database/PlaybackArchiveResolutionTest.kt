...
class PlaybackArchiveResolutionTest {
    ...
    fun catchupIntentMaterializesBeforeExistingAccessPolicyAndCarriesTimeline() = runTest {
        ...
        // The archive transport is materialized first, then validated by the existing
        // credential-bound direct-source policy. This preserves exact-origin HTTP ownership.
